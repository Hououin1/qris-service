...
exports.env = {
    ...
    orderKuotaUsername: process.env.ORDERKUOTA_USERNAME?.trim() ??
        process.env.OK_USERNAME?.trim() ??
        process.env.ORKUT_USERNAME?.trim() ??
        "",
    orderKuotaPassword: process.env.ORDERKUOTA_PASSWORD?.trim() ??
        process.env.OK_PASSWORD?.trim() ??
        process.env.ORKUT_PASSWORD?.trim() ??
        "",
    orderKuotaToken: process.env.ORDERKUOTA_TOKEN?.trim() ??
        process.env.OK_TOKEN?.trim() ??
        "",
    qrisStatic: process.env.QRIS_STATIC?.trim() ??
